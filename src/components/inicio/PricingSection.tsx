...
const plans = [
  {
    ...
    description: 'Para probar y empezar a digitalizarte. Incluye 14 días de Starter gratis.',
    badge: '14 días Starter gratis 🎉',
    features: [
      'Menú digital (hasta 15 productos)',
      'Código QR personalizado',
      'Hasta 40 pedidos/día',
      'Pagos manuales (Efectivo y Transferencia)',
  ...
  },
  {
    ...
    description: 'Empieza a cobrar ordenadamente y sin errores.',
    badge: null,
    features: [
      'Todo lo de Gratis',
      'Menú digital (hasta 100 productos)',
      'Pedidos ilimitados',
      'Múltiples categorías',
      'Control de Stock e Inventario Vivo',
      'Analíticas de ventas básicas'
    ],
    cta: 'Empezar Starter',
    popular: true,
  },
  {
    ...
    period: '/mes',
    cancelText: 'Cancela cuando quieras',
    description: 'Cobra automático y deja de depender del cajero.',
    badge: null,
    features: [
      'Todo lo de Starter',
      'Notificaciones WhatsApp al cliente',
      'Pagos online integrados (Tarjetas / Apps)',
      'Costo por producto y análisis de margen',
      'Tiempos de preparación avanzados',
  ...
  },
  {
    ...
    period: '/mes',
    cancelText: 'Cancela cuando quieras',
    description: 'Control operacional total: cocina, insumos, costos y sucursales.',
    badge: null,
    features: [
      'Todo lo de Pro',
      'Multi-sucursales',
      'Múltiples administradores de caja',
      'Integración POS externo',
      'Control de insumos y recetas (descuento automático por pedido)',
